                ...
                <div class="card__inner">
                    <article class="card">
                        <figure class="card__header">
                            <img class="card__img" src="../asset/img/card01.png" alt="이미지1">
                        </figure>
                    ...
                    <article class="card">
                        <figure class="card__header">
                            <img class="card__img" src="../asset/img/card02.jpg" alt="이미지2">
                        </figure>
                        <div class="card__body">
                    ...
                    <article class="card">
                        <figure class="card__header">
                            <img class="card__img" src="../asset/img/card03.jpg" alt="이미지3">
                        </figure>
                        <div class="card__body">
    ...
    if($result){
        ...
        if($count > 0){
            for($i=1; $i<=$count; $i++){
                ...
                echo "<span class='face'><img src='../asset/img/face.png' alt='얼굴'></span>";
