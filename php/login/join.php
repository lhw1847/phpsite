...
<script>
    ...
    function joinChecks(){
        ...
        //이름 공백 검사
        if($("#youName").val() == ""){
            $("#youNameComment").text("비밀번호를 입력해주세요!");
            return false;
        }
        ...
        if(!getName.test($("#youName").val())){
            $("#youNameComment").text("닉네임은 한글만 사용할 수 있습니다!");
            $("#youName").val("");
            return false;
        }
        ...
        if(!getBirth.test($("#youBirth").val())){
            $("#youBirthComment").text("생년월일 형식(YYYY-MM-DD)에 맞게 입력해주세요!");
            $("#youBirth").val("");
            return false;
        }
        ...
        if(!getPhone.test($("#youPhone").val())){
            $("#youPhoneComment").text("휴대폰 번호 형식(010-0000-0000)에 맞게 입력해주세요!");
            $("#youPhone").val("");
            return false;
        }
    }
